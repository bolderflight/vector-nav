...
// bool Vn300::EnableDrdyInt(uint16_t srd) {
...
// bool Vn300::SetAntennaBaseline(Eigen::Vector3f b, Eigen::Vector3f uncertainty) {
//   vector_nav::vn300::GpsCompassBaseline baseline;
//   baseline.payload.position_x = b(0);
//   baseline.payload.position_y = b(1);
//   baseline.payload.position_z = b(2);
//   baseline.payload.uncertainty_x = uncertainty(0);
//   baseline.payload.uncertainty_x = uncertainty(1);
//   baseline.payload.uncertainty_x = uncertainty(2);
//   error_code_ = vector_nav_.WriteRegister(baseline);
//   return (error_code_ == VectorNav::ERROR_SUCCESS);
// }

// bool Vn300::GetAntennaBaseline(Eigen::Vector3f *b, Eigen::Vector3f *uncertainty) {
//   if ((!b) || (!uncertainty)) {
//     error_code_ = VectorNav::ERROR_NULL_PTR;
//     return false;    
//   }
//   vector_nav::vn300::GpsCompassBaseline baseline;
//   error_code_ = vector_nav_.ReadRegister(&baseline);
//   if (error_code_ != VectorNav::ERROR_SUCCESS) {return false;}
//   (*b)(0) = baseline.payload.position_x;
//   (*b)(1) = baseline.payload.position_y;
//   (*b)(2) = baseline.payload.position_z;
//   (*uncertainty)(0) = baseline.payload.uncertainty_x;
//   (*uncertainty)(1) = baseline.payload.uncertainty_y;
//   (*uncertainty)(2) = baseline.payload.uncertainty_z;
//   return true;
// }
